...
public class Nowclasspeople extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view=inflater.inflate(R.layout.fragment_nowclasspeople, container, false);
        return view;
    }
...
//                mListener.onNowclasspeopleFragmentInteraction("tlq");
        ...
        StuListAdapter usersAdapter = new StuListAdapter(getView().getContext(), arrayOfUsers);

        ListView listView = view.findViewById(R.id.allclassmatesview);
