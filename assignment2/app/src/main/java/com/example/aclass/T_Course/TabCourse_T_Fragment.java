package com.example.aclass.T_Course;
...
import com.example.aclass.S_Course.AddCourseDialog;
 ...
 * Use the {@link TabCourse_T_Fragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TabCourse_T_Fragment extends Fragment {
     ...
     * @return A new instance of fragment TabCourse_T_Fragment.
     */
    // TODO: Rename and change types and number of parameters
    public static TabCourse_T_Fragment newInstance(String param1, String param2) {
        TabCourse_T_Fragment fragment = new TabCourse_T_Fragment();
...
//                    sqLiteDatabase.execSQL("delete from courses where course_name = ?", new String[] {course.getCourseName()});
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.on_T_courseFragmentInteraction(uri);
        }
    }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void on_T_courseFragmentInteraction(Uri uri);
    }
}
