...
TabList_S_Fragment.OnFragmentInteractionListener, TabMe_S_Fragment.OnFragmentInteractionListener,Nowclasspeople.OnFragmentInteractionListener,
        SiliaoTeacher_Fragment.OnFragmentInteractionListener{
//    SiliaoTeacher_Fragment.OnFragmentInteractionListener, Taolunqu.OnFragmentInteractionListener {
...
//    private Taolunqu tlq_fragment;
    private SiliaoTeacher_Fragment siliao_fragment;
    //private
    @Override
    ...
    public void onClassFragmentInteraction(String choice){
        ...
        if(choice.equals("toCourse")){
            if(this.tabCourseSFragment!=null){
                fragmentManager.beginTransaction()
                        .replace(R.id.fl_container,tabCourseSFragment,null)
                        .addToBackStack(null)
                        .commit();
            }
            else{
...
//        }
        if(choice.equals("siliao")){
            siliao_fragment= SiliaoTeacher_Fragment.newInstance("123","123");
            fragmentManager.beginTransaction()
